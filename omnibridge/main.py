...
from omnibridge.cli.argument_parser.argument_parser import add_api_key_arguments, add_chatgpt_arguments, add_dalle_arguments
...
def run() -> int:
    ...
    command_function = COMMAND_TO_FUNCTION.get(args['command'], SAVED_DATA_FILE_PATH)
    if command_function:
